...
create_table_query = """
CREATE TABLE IF NOT EXISTS validated_reviews_jacket (
...
with open('validated_reviews_jacket.csv', mode='w', newline='', encoding='utf-8') as file:
    ...
    for row in rows:
        ...
        try:
            ...
            try:
                ...
                continue
            insert_query = """
            INSERT INTO validated_reviews_jacket ( clothing_id ,review_id, review, rating, recommend, validation_result, problem_category)
